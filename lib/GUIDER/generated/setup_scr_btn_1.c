...
void setup_scr_btn_1(lv_ui *ui){
	...
	//Write codes btn_1_WIFISet
	ui->btn_1_WIFISet = lv_btn_create(ui->btn_1);
	lv_obj_set_pos(ui->btn_1_WIFISet, 122, 39);
	lv_obj_set_size(ui->btn_1_WIFISet, 77, 22);
	lv_obj_set_scrollbar_mode(ui->btn_1_WIFISet, LV_SCROLLBAR_MODE_OFF);

	//Set style for btn_1_WIFISet. Part: LV_PART_MAIN, State: LV_STATE_DEFAULT
	lv_obj_set_style_radius(ui->btn_1_WIFISet, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->btn_1_WIFISet, lv_color_make(0x21, 0x95, 0xf6), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_color(ui->btn_1_WIFISet, lv_color_make(0x21, 0x95, 0xf6), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_dir(ui->btn_1_WIFISet, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_opa(ui->btn_1_WIFISet, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_width(ui->btn_1_WIFISet, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_color(ui->btn_1_WIFISet, lv_color_make(0x21, 0x95, 0xf6), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_opa(ui->btn_1_WIFISet, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_spread(ui->btn_1_WIFISet, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_ofs_x(ui->btn_1_WIFISet, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_ofs_y(ui->btn_1_WIFISet, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_color(ui->btn_1_WIFISet, lv_color_make(0x21, 0x95, 0xf6), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_width(ui->btn_1_WIFISet, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_opa(ui->btn_1_WIFISet, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_color(ui->btn_1_WIFISet, lv_color_make(0xff, 0xff, 0xff), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->btn_1_WIFISet, &lv_font_simsun_16, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_align(ui->btn_1_WIFISet, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
	ui->btn_1_WIFISet_label = lv_label_create(ui->btn_1_WIFISet);
	lv_label_set_text(ui->btn_1_WIFISet_label, "WIFI配置");
	lv_obj_set_style_pad_all(ui->btn_1_WIFISet, 0, LV_STATE_DEFAULT);
	lv_obj_align(ui->btn_1_WIFISet_label, LV_ALIGN_CENTER, 0, 0);
